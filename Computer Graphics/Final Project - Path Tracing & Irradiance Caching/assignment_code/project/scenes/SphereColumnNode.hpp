#ifndef SPHERE_COLUMN_NODE_H_
#define SPHERE_COLUMN_NODE_H_
...
namespace GLOO {
class SphereColumnNode : public SceneNode {
public:
    SphereColumnNode(bool add_sphere, bool delete_sphere, bool mirror) {
    ...
    positions.push_back(glm::vec3(0, 1.25, 0));
    positions.push_back(glm::vec3(0, -0.25, 0));
    positions.push_back(glm::vec3(0, -1.75, 0));

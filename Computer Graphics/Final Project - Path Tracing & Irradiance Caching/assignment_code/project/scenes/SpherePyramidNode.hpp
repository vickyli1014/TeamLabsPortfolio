#ifndef SPHERE_PYRAMID_NODE_H_
#define SPHERE_PYRAMID_NODE_H_
...
namespace GLOO {
class SpherePyramidNode :public SceneNode {
public:
    SpherePyramidNode(bool add_sphere, bool delete_sphere, bool mirror) {
    ...
    // CreateComponent<LightComponent>(std::move(point_light));
    // add light node, did not add

    // declare positions
    std::vector<glm::vec3> positions;
    positions.push_back(glm::vec3(-1.5, -3.25, -1.5));
    positions.push_back(glm::vec3(0, -3.25, -1.5));
    positions.push_back(glm::vec3(1.5, -3.25, -1.5));
    positions.push_back(glm::vec3(-1.5, -3.25, 0));
    positions.push_back(glm::vec3(0, -3.25, 0));
    positions.push_back(glm::vec3(1.5, -3.25, 0));
    positions.push_back(glm::vec3(-1.5, -3.25, 1.5));
    positions.push_back(glm::vec3(0, -3.25, 1.5));
    positions.push_back(glm::vec3(1.5, -3.25, 1.5));
    positions.push_back(glm::vec3(-0.75, -2.05, -0.75));
    positions.push_back(glm::vec3(0.75, -2.05, -0.75));
    positions.push_back(glm::vec3(-0.75, -2.05, 0.75));
    positions.push_back(glm::vec3(0.75, -2.05, 0.75));
    positions.push_back(glm::vec3(0, -0.85, 0));

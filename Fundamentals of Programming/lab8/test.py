...
def test_simplify_00():
    ...
    expected = lab.Var('x')
    print('expected: ', symbol_rep(expected))
    print('result: ', symbol_rep(result))
    print()
...
def test_simplify_02():
    ...
    result = lab.Div(lab.Num(1), lab.Mul(lab.Num(2), lab.Var('v'))).simplify()
    print(result)
...
def test_parse_01():
    result = lab.sym(read_expected('188_in.pyobj'))
    expected = read_expected('188_out.pyobj')
    assert symbol_rep(result) == symbol_rep(expected)

    result = lab.sym(read_expected('189_in.pyobj'))
    expected = read_expected('189_out.pyobj')
    assert symbol_rep(result) == symbol_rep(expected)

    result = lab.sym(read_expected('190_in.pyobj'))
    expected = read_expected('190_out.pyobj')
    assert symbol_rep(result) == symbol_rep(expected)

    result = lab.sym(read_expected('191_in.pyobj'))
